#
#  Be sure to run `pod spec lint EasyRoot.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = 'EasyRoot'
  s.version      = '1.0.1'
  s.summary      = 'Simplify radical expression in Swift.'
  ...
  s.description  = <<-DESC
                ...
                Currently supports simplifying integer-only radicals
